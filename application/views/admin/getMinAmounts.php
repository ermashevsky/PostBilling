...
<section id="main" class="column">
		...
		<h4 class="alert_info">Построение отчета по минимальным суммам</h4>

		<article class="module width_full">
		<header>
			<h3 class="tabs_involved">Построение отчета по минимальным суммам</h3>
		</header>
		...
		<div class="spacer"></div>
			<footer>
				...
				<div class="submit_link">
					<input type="submit" value="Сформировать" class="alt_btn" onclick="getMinAmounts(); return false;">
					<input type="submit" value="Начислить разницу" class="alt_btn" id="target" />
				</div>
			</footer>
