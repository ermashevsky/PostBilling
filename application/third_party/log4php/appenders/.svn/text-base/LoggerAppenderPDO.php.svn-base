...
class LoggerAppenderPDO extends LoggerAppender {
	 ...
	 */
	protected $insertSQL = "INSERT INTO __TABLE__ (timestamp, logger, level, method, user, message, thread, file, line) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	 ...
	 */
	protected $insertPattern = "%date{Y-m-d H:i:s},%logger,%level,%method,%message,%pid,%file,%line";
