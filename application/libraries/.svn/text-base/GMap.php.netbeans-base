...
class Gmap {
    ...
    function getHeaderJS() {
		...
		if(!empty($this->_elevation_polylines)||(!empty($this->_directions)&&$this->elevation_directions)){
			$_headerJS .= "<script type='text/javascript' src='http://www.google.ru/jsapi'></script>";
			$_headerJS .= "
        ...
        $_headerJS .= "<script type='text/javascript' src='http://maps.google.ru/maps/api/js?sensor=".(($this->mobile==true)?"true":"false")."'></script>";
