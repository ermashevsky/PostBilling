	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/assets/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/assets/images/progressbg_red.gif',
									30: '/assets/images/progressbg_orange.gif',
									70: '/assets/images/progressbg_green.gif'
								},
